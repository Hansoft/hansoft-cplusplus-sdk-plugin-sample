...
public:
	...
	void UpdateServer()
	{
		...
		// Add plugins. You need a Win32 x86 and x64 and OS X 10.7 x64 and 10.5 x86 and x64 versions built when you run the program. Both are required. If you create your own application make sure to use a directory for a reverse domain name that you own. Remove ifdefs and comments in real deployer
